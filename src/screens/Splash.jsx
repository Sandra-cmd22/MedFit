...
const Splash = () => {
    ...
    return (
        <div className="splash-container">
            ...
            <img src={splashImg} alt="MedFit" className="splash-img" /> {/* Corrigida a classe */}
            <div className="splash-card">
                <h2 className="splash-title">Pronto para começar sua jornada?</h2>
                <p className="splash-subtitle">Seu progresso, registrado de forma simples.</p>
                <div className="splash-buttons">
                    <button className="primary-btn" onClick={() => navigate("/cadastro")}>
                        Cadastrar Cliente
                    </button>
                    <button className="secondary-btn" onClick={() => navigate('/clientes')}>
                        Ver Cliente
                    </button>
                </div>
            </div>
